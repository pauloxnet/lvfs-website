...
def route_verfmt_create():
    ...
    return redirect(url_for('.route_verfmt_details', verfmt_id=verfmt.verfmt_id))

@app.route('/lvfs/verfmt/<int:verfmt_id>/delete')
@login_required
@admin_login_required
def route_verfmt_delete(verfmt_id):
...
@login_required
@admin_login_required
def route_verfmt_modify(verfmt_id):
    ...
    return redirect(url_for('.route_verfmt_details', verfmt_id=verfmt_id))

@app.route('/lvfs/verfmt/<int:verfmt_id>/details')
@login_required
@admin_login_required
def route_verfmt_details(verfmt_id):
