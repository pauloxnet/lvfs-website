...
@login_required
def route_agreement_show(agreement_id=None):
...
def route_agreement_create():
    ...
    return redirect(url_for('.route_agreement_modify', agreement_id=agreement.agreement_id))

@app.route('/lvfs/agreement/<int:agreement_id>/accept')
@login_required
def route_agreement_confirm(agreement_id):
...
@login_required
def route_agreement_decline(agreement_id=None):
...
@login_required
@admin_login_required
def route_agreement_modify(agreement_id):
    ...
    if not agreement:
        ...
        return redirect(url_for('.route_agreement_list'))
    ...
    return redirect(url_for('.route_agreement_modify', agreement_id=agreement_id))

@app.route('/lvfs/agreement/<int:agreement_id>/delete')
@login_required
@admin_login_required
def route_agreement_delete(agreement_id):
