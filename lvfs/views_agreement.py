...
@app.route('/lvfs/agreements')
@app.route('/lvfs/agreements/<int:agreement_id>')
@login_required
def route_agreements_show(agreement_id=None):
...
@app.route('/lvfs/agreements/list')
@login_required
@admin_login_required
def route_agreements_list():
...
@app.route('/lvfs/agreements/create')
@login_required
@admin_login_required
def route_agreements_create():
    ...
    return redirect(url_for('.route_agreements_modify', agreement_id=agreement.agreement_id))

@app.route('/lvfs/agreements/<int:agreement_id>/accept')
@login_required
def route_agreements_confirm(agreement_id):
...
@app.route('/lvfs/agreements/decline')
@app.route('/lvfs/agreements/<int:agreement_id>/decline')
@login_required
def route_agreements_decline(agreement_id=None):
    g.user.agreement_id = None
    db.session.commit()
    flash('Recorded decline of the agreement %i' % agreement_id)
    return redirect(url_for('.route_index'))

@app.route('/lvfs/agreements/<int:agreement_id>/modify', methods=['GET', 'POST'])
@login_required
@admin_login_required
def route_agreements_modify(agreement_id):
    ...
    if not agreement:
        ...
        return redirect(url_for('.route_agreements_list'))
    ...
    return redirect(url_for('.route_agreements_modify', agreement_id=agreement_id))

@app.route('/lvfs/agreements/<int:agreement_id>/delete')
@login_required
@admin_login_required
def route_agreements_delete(agreement_id):
