...
def route_category_create():
    ...
    return redirect(url_for('.route_category_details', category_id=cat.category_id))

@app.route('/lvfs/category/<int:category_id>/delete')
@login_required
@admin_login_required
def route_category_delete(category_id):
...
@login_required
@admin_login_required
def route_category_modify(category_id):
    ...
    return redirect(url_for('.route_category_details', category_id=category_id))

@app.route('/lvfs/category/<int:category_id>/details')
@login_required
@admin_login_required
def route_category_details(category_id):
